- dashboard: csc_scorecard_weekly
  ...
  - title: Call Distribution
    ...
    listen:
      ...
      time: incontact_clone.start_week
    row: 6
    col: 8
    width: 8
    height: 6
  ...
  - title: Call Statistics
    ...
    sorts:
    - incontact_clone.start_week desc
    limit: 500
    column_limit: 50
    query_timezone: America/Denver
    show_view_names: false
  ...
  - title: Referred via Phone Screen
    ...
    type: looker_column
    fields:
    - care_request_flat.requested_week
    - care_request_flat.care_request_count
    ...
    listen:
      market name: markets.name
      time: care_request_flat.requested_week
    row: 6
    col: 16
    width: 8
    height: 6
  ...
  - title: General Risk Protocol
    ...
    type: looker_line
    fields:
    - care_request_flat.created_week
    ...
    sorts:
    - care_request_flat.created_week 0
    limit: 500
    total: true
    query_timezone: America/Denver
    stacking: ''
    ...
    listen:
      market name: markets.name
      time: care_request_flat.created_week
    row: 24
    col: 5
    width: 8
    height: 6
  - title: Call Survey Results
    ...
    filters: {}
    sorts:
    - csc_survey_clone.date_week desc
    limit: 500
    query_timezone: America/Denver
    show_view_names: false
    show_row_numbers: true
  ...
  - name: time
    ...
    explore: care_requests
    listens_to_filters: []
    field: incontact_clone.start_week
